...
%	\end{align}
	...
	\begin{align*}
		...
		&=(m-2)(m-1)(\frac{1}{6}(2m-3)-\frac{(m-2)(m-1)}{2n}+\frac{1}{2}\frac{(m-2)(m-1)}{2n})=\\
		&=(m-2)(m-1)(\frac{1}{6}(2m-3)-\frac{1}{2}\frac{(m-2)(m-1)}{2n})
	\end{align*} 
	...
	\begin{align*}
		...
		&(m-1)[(m-2)(m-1)(\frac{2}{3}(2m-3)-(m-2))-8]>0\\
		&(m-1)[(m-2)(m-1)(\frac{4m-6-3m+6}{3})-8]>0\\
		&(m-1)[(m-2)(m-1)(\frac{m}{3})-8]>0\\
	\end{align*}
	The first coefficient $(m-1)$ is always positive, so consider only the second term:
	\begin{align*}
		&(m-2)(m-1)(\frac{m}{3})-8>0\\
		&\frac{(m-2)(m-1)m}{3}>8\\
		&(m-2)(m-1)m>24\\
	\end{align*}
