...
The mean absolute difference is a measure of dispersion calculated as the arithmetic mean of the absolute value of all possible differences. It satisfies both PEr and PPd. To see that consider the following vectors:
\begin{example}
	...
	If we compute the $\sigma_{mad}$ of these vectors we have:
	\begin{align}
