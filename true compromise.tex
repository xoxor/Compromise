...
TODO Olivier: Add $\rho_n$ and let $k$ be the level of $y$, we show that $\rho_n < k$.
%I prefer Remzi's one this time
\commentOC{I suggest this  alternative, as a remplacement of the second paragraph.}

Considering any $x \in f_n(P)$, let us show that $x \in \mustar[\bar{\sigma}]$. Because $x \in \paretopt(P)$, suffices to show that $\forall y \in \paretopt(P)$, $\bar{\sigma}(\lambda_P(y)) ≥ \bar{\sigma}(\lambda_P(x))$. Given the choice of $\bar{\sigma}$, picking any $y \in \paretopt(P)$, suffices to show that $\bar{\sigma}(\lambda_P(y)) = 1$, equivalently, that $\exists i, j \in N \suchthat r_{\prefi}(y) ≠ r_{\pref_j}(y)$. 
Because $x \in f_n(P)$, $\rho_n(P) = \rho_n(x, P) = \min_i r_{\prefi}(x)$.
It follows from $\rho_n(P) = \min_{x \in A} \set{\rho_n(x, P)}$ that $\rho_n(y, P) ≥ \rho_n(x, P)$, thus, $\exists i \in N \suchthat r_{\prefi}(y) > \rho_n(P)$. 
...
\commentOC{Less direct version}

Considering any $x \in f_n(P)$, let us show that $x \in \mustar[\bar{\sigma}]$. Because $x \in \paretopt(P)$, suffices to show that $\forall y \in \paretopt(P)$, $\bar{\sigma}(\lambda_P(y)) ≥ \bar{\sigma}(\lambda_P(x))$. Equivalently, picking any $y$ such that $\bar{\sigma}(\lambda_P(y)) < \bar{\sigma}(\lambda_P(x))$, let us show that $y \notin \paretopt(P)$. Given the choice of $\bar{\sigma}$, we must have $\bar{\sigma}(\lambda_{P}(y))=0$. Thus, $\forall i,j\in N: r_{\succ _{i}}(y)=r_{\succ _{j}}(y)$.
Because $x \in f_n(P)$, $\rho_n(P) = \rho_n(x, P) = \min_i r_{\prefi}(x)$. 
Also, it follows from $\rho_n(P) = \min_{x \in A} \set{\rho_n(x, P)}$ that $\rho_n(y, P) ≥ \rho_n(x, P)$, thus, $\exists i \in N \suchthat r_{\prefi}(y) > \rho_n(P)$. And because  $\forall i, j\in N: r_{\succ _{i}}(y)=r_{\succ _{j}}(y)$, $y$ is pareto-dominated by $x$.

\commentOC{Verbose version}

Considering any $x \in f_n(P)$, let us show that $x \in \mustar[\bar{\sigma}]$. Because $x \in \paretopt(P)$, suffices to show that $\forall y \in \paretopt(P)$, $\bar{\sigma}(\lambda_P(y)) ≥ \bar{\sigma}(\lambda_P(x))$. Given the choice of $\bar{\sigma}$, picking any $y \in \paretopt(P)$, suffices to show that $\bar{\sigma}(\lambda_P(y)) = 1$, equivalently, that $\exists i, j \in N \suchthat r_{\prefi}(y) ≠ r_{\pref_j}(y)$. 
Because $x \in f_n(P)$, $\rho_n(P) = \min_i r_{\prefi}(x)$, the worst rank of $x$.
Because $y \in \paretopt(P)$, $y$ is considered better than $x$ by some voter $i$, thus $y$ is ranked higher than $\rho_n(P)$ by $i$. But $y$ can’t be ranked unanimously higher than $\rho_n(P)$, thus, some voter $j$ ranks it lower than $\rho_n(P)$. Therefore, $r_{\prefi}(y) ≠ r_{\pref_j}(y)$. \commentOC{ (Formally, $\exists i \in N \suchthat r_{\prefi}(y) < \rho_n(P)$.) (Formally, $\exists j \in N \suchthat r_{\pref_j}(y) ≥ \rho_n(P)$.)}
\end{proof}
