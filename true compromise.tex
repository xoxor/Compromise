...
\begin{proof} for $\sigma_{ad}$. \\
	...
	\begin{align}
		s(l_2)&= \sum_{i=1}^{m-2}{|i-\frac{(m-2)(m-1)}{2n}|+(n-(m-2))|\frac{(m-2)(m-1)}{2n}|} \\
		&= \sum_{i=1}^{m-2}{|i-\frac{(m-2)(m-1)}{2n}|+(n-m+2)\frac{(m-2)(m-1)}{2n}}\\
		&=\sum_{i=1}^{\ceil{\bar{l_2}}}{(i-\frac{(m-2)(m-1)}{2n})} + \sum_{i=\floor{\bar{l_2}}}^{m-1}{(i-\frac{(m-2)(m-1)}{2n})} \\ &+(n-m+2)\frac{(m-2)(m-1)}{2n}\\
	\end{align}
