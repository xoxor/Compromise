...
%\end{proof}
This is of course only a partial relief for the lovers of both these principles, as such a compatible rule must fail to be Paretian. \commentRS{Can we find a more direct way to say this?}
