...
\begin{definition}
    Given any $m \geq 4$, a spread measure $\sigma$ satisfies condition $D_m$ iff $\sigma(k+1,k-1)<\sigma(0,k)$ for some $k ≤ m-2$.
\end{definition}
...
\begin{theorem}
	Let $m \geq 5$. Under $\sigma \in \Sigma^{D_{m}}$, FB and PV fail PCC. Furthermore, when $m$ is odd, VR and SL also fail PCC. 
\end{theorem}
...
\begin{proof}
    Let $\sigma$ be any spread measure in $D_m$, and let $k$ be any value for which $\sigma$ satisfies $D_m$.
