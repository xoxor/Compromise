...
The condition is more reasonable for bigger values of $m$ and $n$. In fact asking for $\sigma(0,2,1)$ to be smaller than $\sigma(1,0,0)$ is not as convincing than asking for $\sigma(3,5,4,4,4)$ to be smaller than $\sigma(4,3,2,1,0)$.
...
\commentBN{Summarize. Just say that we'll check some of the most used sp in inequality theory and reference them.}
...
In the years many measures of inequality have been proposed \citep{Jackman1974, Rubinson1977, Martin1971, Ray1973, Schutz1951, Theil1967} but perhaps the most commonly used is the Gini coefficient, G, which is defined as the ratio of the area between the Lorenz curve and the diagonal (line of equality), over the total area under the line of equality.
...
\begin{proposition}
	$\sigma_{mad}$ satisfies condition C for $\forall m\geq4$ and $n\geq\max\{4,m-1\}$ and $\sigma_{ad}$, $\sigma_{sd}$ and $\sigma_{G}$ satisfy condition C $\forall m \geq 4 $ and $ n\geq 4$.
\end{proposition}
