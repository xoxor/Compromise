...
\commentBN{TO CHECK}
\begin{theorem}
	$\sigma_{mad}$ satisfies condition C $\forall n\geq 3$ and $\forall m \geq 4$.
\end{theorem}
\begin{proof} 
	Consider the two vectors $l_1=(m-3, m-1, m-2, m-2, m-2)$ and $l_2=(m-2, m-3, 1, 0, 0)$; their spread using the Mean Absolute Difference will be: 
	\small{\[\sigma_{mad}(l_1)=\frac{|m-3-m+1|+|m-3-m+2|+\dots}{5^2}=\frac{18}{5^2}\]
	\[\sigma_{mad}(l_2)=\frac{|m-2-m+3|+|m-2-1|+\dots}{5^2}=\frac{6+6|m-3|+4|m-2|+2|m-4|}{5^2}\]}
	In order $\sigma_{mad}$ to satisfy condition C, must be $\sigma_{mad}(l_1) < \sigma_{mad}(l_2)$, so
	\[18<6+6|m-3|+4|m-2|+2|m-4|\]
	which is true for all $m\geq4$.
\end{proof}
\begin{example}
	For $m=3$, $l_1=(0,2,1,1,1)$ and $l_2=(1,0,1,0,0)$. Therefore, $\sigma_{mad}(l_1)=\frac{22}{5^2}$ is greater than $\sigma_{mad}(l_2)=\frac{12}{5^2}$.
	
	For $m=4$, instead, $l_1=(1,3,2,2,2)$ and $l_2=(2,1,1,0,0)$. Resulting on $\sigma_{mad}(l_1)=\frac{16}{5^2}$ less than $\sigma_{mad}(l_2)=\frac{20}{5^2}$.
\end{example}
