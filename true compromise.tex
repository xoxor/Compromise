...
\commentRS{I revised the abstract. Let's first agree on that and then see what to do here.}
...
\commentBN{Could we add a link to an external document where we write the full proofs? (For example in GitHub.)}
...
\commentRS{I see his point. Let's discuss this face-to-face.}

\section{Two-voters case}
\commentRS{I changed the introductory paragraph of this section. I am not super happy with it. Let's discuss later.}
Collective choice environments with two-individuals are usually viewed as arbitration or bargaining problems. \commentRS{We need one or more adequate citations here. Also, I suggest to place here a footnote which says "There are analyses of these problems, such as \citep{Kibris2007}, where the model admits an explicit disagreement outcome. We remain in the classical collective choice environment with no explicit disagreement alternative.} 
