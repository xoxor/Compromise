...
\begin{proposition} For $n>2$, $m\geq3$ \commentBN{Generalize for n=2 (classical bargaining setting)} \label{prop:rulesnotPCC}
	\begin{item}
...
\begin{proposition}
	For $n>2$, $m=3$ some scoring rules are  $PCC$ \commentBN{Generalize for n=2}
\end{proposition}
\begin{proof}
