...
\begin{proof} for $\sigma_{ad}$. \\
	...
	\[\bar{l_2}= \frac{m-2+m-3+ \dots+ m-(m-1)+0+ \dots+0}{n}=\frac{1}{n}\sum_{i=2}^{m-1}{m-i}= \frac{(m-2)(m-1)}{2n}\]
	\begin{align}
		s(l_2)&= \sum_{i=2}^{m-1}{|(m-i)-\frac{(m-2)(m-1)}{2n}|+(n-(m-2))|\frac{(m-2)(m-1)}{2n}|} \\
		&= \sum_{i=2}^{m-1}{|(m-i)-\frac{(m-2)(m-1)}{2n}|-(n-m+2)\frac{(m-2)(m-1)}{2n}}\\
		&=\sum_{i=2}^{\ceil{\bar(l_2)}}{((m-i)-\frac{(m-2)(m-1)}{2n})} - \sum_{i=\floor{\bar(l_2)}}^{m-1}{((m-i)-\frac{(m-2)(m-1)}{2n})} \\ &-(n-m+2)\frac{(m-2)(m-1)}{2n}\\
	\end{align}
