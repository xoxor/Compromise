...
In this section, we are interested in analyzing the following classes of social choice rules. \emph{All} Egalitarian Compromises winners are among the alternatives with most equally distributed losses; while \emph{some} Egalitarian Compromise Compatible winners are among the alternatives with most equally distributed losses. \commentBN{I would put this phrasing after the definitions, I find hard to follow if I don't know what an EC is.}
